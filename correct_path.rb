...
# input string will be entirely composed of: r, l, u, d, ?. Each of the characters
#  stand for the direction to take within the grid,
#  for example: r = right, l = left, u = up, d = down.
#   Your goal is to determine what characters the question marks should be
#   in order for a path to be created to go from the top left of the grid all
#   the way to the bottom right without touching previously travelled on cells
#   in the grid.
